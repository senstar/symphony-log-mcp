...
const EXACT_PREFIXES: Record<string, PrefixInfo> = {
  ...
  mo:     { description: "Mobile Bridge",         category: "Server",        side: "server" },
  ...
  ka:     { description: "KillAll",               category: "Tools",         side: "tool" },
  ...
  // Verified prefixes from FormViewLogs.cs ConvertPrettyName
  ai:     { description: "Installer",             category: "Tools",         side: "tool" },
  ba:     { description: "BaseLibCS.Info",          category: "Server",        side: "server" },
  bk:     { description: "DB Backup",              category: "Tools",         side: "tool" },
  in:     { description: "License Document Parser", category: "Tools",         side: "tool" },
  ml:     { description: "Message Listener",        category: "Server",        side: "server" },
  ms:     { description: "Installer (msiexec)",     category: "Tools",         side: "tool" },
  pe:     { description: "Footage File Info",       category: "Tools",         side: "tool" },
  pr:     { description: "PrintShmem",              category: "Tools",         side: "tool" },
  sr:     { description: "Schedule Report",         category: "Tools",         side: "tool" },
  ss:     { description: "Single Sign-On",          category: "SSO",           side: "server" },
